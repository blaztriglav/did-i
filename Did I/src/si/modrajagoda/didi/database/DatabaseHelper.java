...
public class DatabaseHelper extends OrmLiteSqliteOpenHelper {
	...
	private Dao<Week, Integer> weekDao;
	private Dao<WeekDetails, Integer> weekDetailsDao;
	...
	public Dao<WeekDetails, Integer> getWeekDetailsDao() throws SQLException {
		if (weekDetailsDao == null) {
			weekDetailsDao = getDao(WeekDetails.class);
		}
		return weekDetailsDao;
	}
